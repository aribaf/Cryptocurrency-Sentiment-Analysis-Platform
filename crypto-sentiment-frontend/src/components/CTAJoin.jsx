...
export default function CTAJoin() {
  return (
    <section className="py-20 bg-[#ff522f]"> {/* Vibrant Orange/Red Background */}
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-black">
          
          {/* Subtitle */}
          <div className="text-sm font-extrabold uppercase text-black/80 mb-2 tracking-widest">
            UNLOCK YOUR EDGE.
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 max-w-lg">
            ...
            <input 
              ...
              className="flex-1 w-full px-5 py-4 rounded-lg border-2 border-black/10 text-lg shadow-inner bg-black text-white placeholder-gray-500" 
            />
            {/* Button is black/dark for maximum contrast */}
            <button 
              className="w-full sm:w-auto px-8 py-4 rounded-lg bg-black text-white font-black text-lg hover:bg-gray-800 transition-colors shadow-lg"
            >
              Get Instant Access
            </button>
          </div>
