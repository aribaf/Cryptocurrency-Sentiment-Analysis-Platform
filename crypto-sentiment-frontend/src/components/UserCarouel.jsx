      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex gap-4 py-2 animate-scroll-slow"> 
          {carouselItems.map((item, i) => (
            <div 
              key={i} 
              className="flex items-center gap-3 bg-black/80 border border-gray-800 px-4 py-3 rounded-full flex-shrink-0"
              style={{ minWidth: '280px' }} // Ensure a minimum width for the quotes
            >
