      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12 items-start">
          ...
          <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div className="p-6 sm:p-8 rounded-lg md:rounded-xl bg-[#ff522f] text-black shadow-xl">
              <div className="text-2xl sm:text-3xl font-black mb-2">UNBIASED DATA</div>
            ...
            <div className="p-6 sm:p-8 rounded-lg md:rounded-xl bg-[#d9ff2f] text-black shadow-xl">
              <div className="text-2xl sm:text-3xl font-black mb-2">ON-CHAIN SYNC</div>
              <p className="text-xs sm:text-sm font-medium">
            ...
            <div className="p-6 sm:p-8 rounded-lg md:rounded-xl bg-gray-900 border border-gray-700 text-white shadow-xl">
              <div className="text-2xl sm:text-3xl font-black mb-2 text-[#8b5cf6]">TREND PREDICTIONS</div>
            ...
            <div className="p-6 sm:p-8 rounded-lg md:rounded-xl bg-gray-900 border border-gray-700 text-white shadow-xl">
              <div className="text-2xl sm:text-3xl font-black mb-2 text-[#00f7ff]">CONFIDENCE METRICS</div>
              <p className="text-xs sm:text-sm font-medium text-gray-400">
